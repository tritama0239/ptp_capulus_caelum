...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <section class="jumbotron ">
        ...
        <div class="row justify-content-center">
            ...
            <form class="form-inline my-2 my-lg-0 ml-auto" method="GET" action="/manager/barang/searchstock">
            ...
            <br />
                <a href="/manager/barang/viewstock" class="btn btn-success refresh" data-toggle="tooltip" title="Print" style="background-color: #CBAB8F" > [ Refresh ]  </i></a>
                <a href="/manager/barang/viewstock/export/" class="btn btn-success" data-toggle="tooltip" title="Print" style="background-color: #CBAB8F" > [ Print ]  </i></a>
