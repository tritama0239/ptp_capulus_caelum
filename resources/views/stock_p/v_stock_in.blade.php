...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Goods | Capulus Caelum</title>
        <style>
        body{
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card-header" align="center"><h3>Add Stock</h3></div>
                    ...
                    <div class="card-body">
                    <form method="POST" action="/pegawai/barang/savestock1">
                @csrf
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="id" class="id">
                            <option disabled selected> - - Item - - </option>
                            @foreach($Barang as $p)
				      		<option value="{{ $p->id_brg }}"> {{ \App\Models\Barang::select('nama_brg')->where('id_brg', $p->id_brg)->value('nama_brg') }} </option >
                            @endforeach
				      	    </select> 
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="stok_in" id="stok_in">
                        </div>

                    </div><br>
                        <button type="submit" id="submit" class="btn btn-primary" style="background-color: #CBAB8F">[+] Add Stock</button>
