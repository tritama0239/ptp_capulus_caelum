    ...
    <section class="jumbotron text-center" padding-top="10px" ><br><br>
        <div class="container" style="background-color: #E7D8CF" > 
            <div class="row justify-content-center">
                <div class="col-md-6">
                        <div class="card-header">{{ __('Who We Are') }}</div>
                        ...
                        <div class="card-body">
                            ...
                            {{ __('Capulus Caelum offers a delicius taste of coffee and roastery.') }}<br>
                            {{ __('We aim to provide an  incredible experience for all our customers.') }}
                        </div>
